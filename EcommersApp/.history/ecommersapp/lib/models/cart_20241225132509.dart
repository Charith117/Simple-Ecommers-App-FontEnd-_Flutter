...
class Cart extends ChangeNotifierProvider {
  ...
  List<Shoe> shoeShop = [
    ...
    Shoe(
        ...
        description:
            'The Nike Air Zoom Pegasus 37 is built for runners at every level, whether you’re a seasoned veteran or just starting out.'),
    Shoe(
