...
class Cart {
  ...
  List<Shoe> shoeShop = [
    ...
    Shoe(
      ...
      description: 'The Nike Air Force 1 is a classic sneaker that has been around since 1982.'
    ),
    Shoe(
      name: 'Nike Air Zoom Pegasus 37',
      price: '120.00',
      imagePath: 'lib/images/nike_air_zoom_pegasus_37.png',
      description: 'The Nike Air Zoom Pegasus 37 is built for runners at every level, whether you’re a seasoned veteran or just starting out.'
    ),
    Shoe(
      name: 'Nike Blazer Mid 77',
      price: '100.00',
      imagePath: 'lib/images/nike_blazer_mid_77.png',
      description: 'The Nike Blazer Mid 77 has a retro look and feel, with a modern twist.'
    ),
    Shoe(
